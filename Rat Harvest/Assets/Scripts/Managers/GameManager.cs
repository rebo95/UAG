...
public class GameManager : MonoBehaviour
{
    ...
    public void NotifyMinutePassed()
    {
        ...
        { 
            ...
            TrackerManager.Instance.TrackEvent(new PlayerPosFirstMinEvent(ref positions));
    ...
    {
        TrackerManager.Instance.TrackEvent(new UserHarvestEvent(plantState, tomatoes)); //plantState, tomatoes
